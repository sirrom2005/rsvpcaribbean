            ...
            <section class="section-41">
                <div class="shell container">
                    ...
                    <div class="section-18">
                        <p>RSVP Caribbean is committed to responsible
                        tourism. All the programmes we support benefit the
                        environment and the local community. All cultural
                        activities and tours have careful guidelines on
                        responsible tourism, community tourism and
                        eco-tourism. This covers but is not limited to
                        waste disposal, recycling, buying from local
                        businesses, not exploiting wildlife or harming the
                        environment.</p>
                        <h4>The RSVP Tourism Policy includes:</h4>
                        <ul class="custom-item-list">
                            <li>Use of local suppliers, staff and
                            businesses where possible</li>
                            <li>Use of sustainable practices on programmes
                            and projects and at our offices</li>
                            <li>Minimizing waste</li>
                            <li>We promote local attractions that do not
                            harm the environment, wildlife and animals</li>
                        </ul>
                    </div>
                </div>
            </section>
