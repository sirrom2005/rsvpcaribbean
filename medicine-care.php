            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Medicine and Health Care Programme</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Medicine and Health Care Programme</h1>
                    ...
                    <div class="section-18">
                            <ul class="custom-item-list">
                                ...
                                <li><b>Types of Partners:</b> Hospitals, Health Centres and Laboratories</li>
                                ...
                                <li><b>Programme Requirements:</b> No specific requirement for pre-medical volunteers, as you
                                will only be able to observe. Medical students will also only observe and any practical work 
                                will be at the discretion of the partner. Professionals will be asked to register to do
                                ...
                                <li>
                                    <b>Price:</b> From $1,900USD per person, <a href="prices-jamaica.php">convert to your currency</a>.
                        ...
                        <div class="section-18">
                            ...
                            resources, to an overburden on the system due to
                            the volume of lifestyle diseases. There continues
                            to be the need for additional support staff to meet
                            the daily workload and improve patient care. As a
                            pre-medical volunteer you can observe at a
                            health-care centre. Medical volunteers can observe
                            at a hospital or health centre dependent on their
                            year in school. Given the legal and ethical
                            considerations only observation opportunities will
                            be guaranteed for non-medical professionals.
                            Professionals can register with the relevant agency
                            in their chosen destination to get practical
                            work.</p>
                            ...
                            volunteers working in health-care centres the
                            departments available for observation include
                            adolescent health, health and wellness, child
                            health, curative health, family planning and
                            ...
                            is important that health care volunteers have
                            ...
                            patients. What you get to do on the healthcare
                            programme is always dependent on your level of
                            training and expertise; and the willingness of the
                            local healthcare professionals to facilitate your
                            involvement.</p>
