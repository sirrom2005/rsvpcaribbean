...
//if(!isset($_SESSION['APPLICATION_FORM']) || empty($_POST)){header('location: apply.php'); exit();}
include_once('./includes/apply/payment-processing.php');
?>
<!DOCTYPE html>
        ...
        <section class="breadcrumb-classic first-bc-margin">
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <h2><span class="big">Payment</span></h2>
                    </div>
                    <div class=
                    ...
                    <div>
                        <div style="text-align:center">
                            ...
                            if($result['ACK'] == 'Failure' || $result['ACK'] == 'FailureWithWarning'){
                                if(isset($result['L_LONGMESSAGE0'])){ $msg1 = $result['L_LONGMESSAGE0'].'<br>'; }
                                if(isset($result['L_LONGMESSAGE1'])){ $msg2 = $result['L_LONGMESSAGE1']; }
                                echo '<h1><span style="color:red;">Payment Failed</span></h1>';
                                echo '<div>'.$msg1.$msg2.'</div>';
                                echo '<h6><a href="checkout.php">Please try again!!</a></h6>';
                            }elseif($result['ACK'] == 'Success' || $result['ACK'] == 'SuccessWithWarning'){
                                if(isset($result['TRANSACTIONID'])){ $msg1 = 'Your tranaction # is ['.$result['TRANSACTIONID'].']'; }
                                echo '<h1><span>Payment completed Successful</span></h1>';
                                echo '<h5>'.$msg1.'</h5>';
                                echo '<h6>Thank you, you will be contacted shortly.</h6>';
                                echo '<h6><a href="index.php">Home</a></h6>';
                            }else{
                                echo "<h1>Server Error</h1>";
                                echo "<h6>Could not connect to payment gateway</h6>";
                                echo '<h6><a href="checkout.php">Please try again!!</a></h6>';
                            }
                            ?>
                        </div>
