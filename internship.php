            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Internship and Dissertation Projects</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Internship and Dissertation Projects</h1>
                    ...
                    <div class="section-18">
                      <ul class="custom-item-list">
                          ...
                          <a href="environmental-awareness.php">Environmental Awareness and Protection</a>, <a href="reggae.php">Reggae Music and Dance</a>, <a href="rastafarian.php">Rastafarian Culture</a> and 
                          ...
                          <li><b>Project Requirements:</b> Completed at least one year of study in required field; for
                          medicine a minimum of 3 years study and a clear description of internship or dissertation objectives</li>
                          ...
                          <li>
                              <b>Price:</b> From $2,100USD per person, <a href="prices-jamaica.php">convert to your currency</a>.
    ...
    $document.ready(function(){
      $('.popup').each(function() {
        $(this).on('click', function() {
          ...
          $.get('layout/project_content.php?project=internship&section=' + getSection, function( data ) {
