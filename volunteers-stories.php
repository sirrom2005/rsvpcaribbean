...
<body>
    ...
    <div class="page">
        ...
        <?php 
        include('layout/volunteers_stories_content.php'); 
          ...
          if(empty($id)):
            ...
            <div class="section-18">
              <article class="post post-default text-left">
                <div class="header post-header">
                  <h3 class="post-title"><a href="volunteers-stories.php?id='. $key .'">'. $content['title'] .'</a></h3>
                  <ul class="post-controls list-inline list-inline-sm p text-dark">
                    <li>
                      ...
                      <time datetime="2016-01-01" class="text-middle small">'. $content['date'] .'</time>
                    </li>
                    <li>
                      <span class="text-middle icon-xxs text-picton-blue mdi mdi-account-outline">&nbsp;</span>
                      <span class="text-middle small">'. $content['author'] .'</span>
                    </li>
                  </ul>
                </div>
                <section class="post-content offset-top-41">
                  <p>'. substr(strip_tags($content['content']), 0, strrpos(substr(strip_tags($content['content']), 0, 400), ' ')) .'...</p>
                  <a href="volunteers-stories.php?id='. $key .'" class="offset-top-24 btn btn-default btn-primary" style="color: #fff">Read More</a>
                </section>
              </article>
            </div>
            ...
            <div class="section-18">
              <article class="post post-default text-left">
                ...
                <section class="post-content offset-top-41">'. $content['content'] .'</section>
              </article>
            </div>
            <hr class="hr offset-top-66">
            ';
