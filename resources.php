...
<body>
    <!-- Page-->
    <div class="page about-t progrrame--and-project resources-page">
        <!-- Page Head-->
        ...
        <section class="breadcrumb-classic first-bc-margin">
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    <div class=
                    "text-center cell-lg-2 veil reveal-sm-block cell-lg-push-2">
                    <span class=
                    ...
                    <div class=
                    "offset-top-10 cell-lg-5 offset-lg-top-0 small cell-lg-push-3 text-lg-right">
