                ...
                <div class="shell container">
                    <div>
                        <div style="text-align:center">
                            <?php     
                            $msg1 = $msg2 = null;
                            if(filter_input(INPUT_GET, 'action') != 'cancel'){
                                echo '<h1><span>Payment completed Successful</span></h1>';
                                echo '<h6>Thank you for your payment.</br>'
                                     . 'Your transaction has been completed, and a receipt for your purchase has been emailed to you.</br>'
                                     .'You may log into your account at <a href="http://www.paypal.com" target="_blank">www.paypal.com</a> to view details of this transaction</h6>';
                            }else{
