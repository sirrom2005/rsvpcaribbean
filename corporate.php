                ...
                <div class="shell container">
                    ...
                    <div class="section-18">
                      <ul class="custom-item-list">
                          ...
                          <a href="environmental-awareness.php">Environmental Awareness and Protection</a>, <a href="rastafarian.php">Rastafarian Culture</a> and <a href="youth-community.php">Youth and Community Development</a></li>
                          
                          <li><b>Minimum Stay:</b> From 1 week</li>
                          <li><b>Sustainable Development Goal:</b> Good Health and Well-Being, No Poverty, Quality Education, Sustainable 
                          Cities and Communities and Climate Action</li>
                          <li><b>Project Requirements:</b> Working for at least one year in relevant field.</li>
                          ...
                          <li><b>Accommodation Type:</b> Host Family or Hotel (price quoted is for host family). If a  hotel is required for the 
                          group please <a href="contact-us.php#collapseThree">Request a Quote</a></li>
                          <li>
                              <b>Price:</b> From $1,600USD per person, based on group size, <a href="prices-jamaica.php">convert to
                              your currency</a>. Please see <a href="prices-jamaica.php">Programme and Project Price</a> for Jamaica
                          </li>
                          <li><b>Meals Included:</b> Breakfast, lunch and dinner (adapted to dietary requirements and necessary)</li>
                          <li>
                          ...
                          <li><b>Age of Volunteer:</b> Must be 20+</li>
                      </ul>
                      <p><b>Let us customize your corporate trip - <a href="contact-us.php">Request a Quote and Timetable</a></b></p>
                    </div>
                </div>
            </section> 
        </main><!-- Page Footer-->
    ...
    $document.ready(function(){
      $('.popup').each(function() {
        $(this).on('click', function() {
          ...
          $.get('layout/project_content.php?project=corporate&section=' + getSection, function( data ) {
