            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Environmental Awareness and Protection Programme</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Environmental Awareness and Protection Programme</h1>
                    ...
                    <div class="section-18">
                      <ul class="custom-item-list">
                          ...
                          <li><b>Types of Partners:</b> Poor and vulnerable communities, government agencies</li>
                          ...
                          <li><b>Sustainable Development Goal:</b> Clean Water and Sanitation, Climate Action</li>
                          <li><b>Programme Requirements:</b> Volunteers with studies or experience in marine biology,
                          waste water management, environmental education, watershed management, tropical
                          ecology, climate change adaptation, sustainable development or any related area are suitable.</li>
                          ...
                          <li>
                              <b>Price:</b> From $1,950USD per person, <a href="prices-jamaica.php">convert to your currency</a>.
                        ...
                        <div class="section-18">
                            <p>The Caribbean is affected by many natural disasters primarily hurricanes, droughts, landslides and earthquakes. Many of these are as a result of how the environment has been 
                            treated overtime. Within the last decade there have been extreme changes in weather patterns which make Caribbean islands more at risk for these disasters. With the effects of climate 
                            change and the continued lack of focus on ensuring that general practices do not further cause deterioration in the environment, much more needs to be done to address this. On the 
                            Environmental Awareness and Protection Programme volunteers will be involved in beach monitoring, maintaining an active buoy deployment, community education and beach and ocean clean-up. 
                            It is recommended that volunteers for this project have previous experience and are knowledgeable in marine biology, waste water management, environmental education, watershed management or 
                            tropical ecology.</p>
                        </div>
                    </div>
                </div>
