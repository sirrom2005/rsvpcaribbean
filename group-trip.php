                ...
                <div class="shell container">
                    ...
                    <div class="section-18">
                      <ul class="custom-item-list">
                          ...
                          <a href="nursing.php">Nursing</a>, <a href="sports.php">Sports</a>, <a href="humanitarian.php">Humanitarian</a>, <a href="rastafarian.php">Rastafarian Culture</a> and 
                          ...
                          <li><b>Project Requirements:</b> Varies, see each programme</li>
                          ...
                          <li><b>Accommodation Type:</b> Host Family or Hotel (price quoted on website is for host
                          family). If a hotel is required for the group please <a href="contact-us.php#collapseThree">Request a Quote</a></li>
                          <li><b>Price:</b> From $1,600USD per person, based on group size, <a href="prices-jamaica.php">convert to your currency</a>.
                          ...
                          transportation to and from the airport, taxi cost from host family to partner agency and on
                          the weekends, please see <a href="what-included.php">What is Included</a> for a full list</li>
                          <li><b>What is Not Included:</b> Airfare, daily lunch, internet, laundry, travel and health
                          insurance, see <a href="what-not-included.php">What is Not Included</a> for a full list</li>
                          <li><b>Start Dates:</b> Flexible</li>
                          <li><b>Age of Volunteer:</b> Must be 16+</li>
                      </ul>
                      <p><b>Let us customize your group trip - <a href="contact-us.php">Request a Quote and Timetable</a></b></p>
                    </div>
                </div>
            </section>
        </main><!-- Page Footer-->
    ...
    $document.ready(function(){
      $('.popup').each(function() {
        $(this).on('click', function() {
          ...
          $.get('layout/project_content.php?project=group_trip&section=' + getSection, function( data ) {
