            ...
            <section class="section-41">
                <div class="shell container">
                    ...
                    <div class="section-41">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mission-vision box-icon box-icon-bordered">
                                    <span class="icon icon-outlined icon-darker-filled mdi mdi-eye"></span>
                                    <h4>Our Vision</h4>
                                    <p>Our vision is to be the leading provider of meaningful and impacting volunteer
                                    opportunities that address critical issues in the Caribbean.</p>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="mission-vision box-icon box-icon-bordered">
                                    <span class="icon icon-outlined icon-darker-filled mdi mdi-walk"></span>
                                    <h4>Our Mission</h4>
                                    <p>Our mission is to identify programmes and projects that are aligned to local
                                    needs and provide mutually beneficial opportunities for volunteers, communities
                                    and partners to make a real difference.</p>
                                </div>
                            </div>
                        </div>
