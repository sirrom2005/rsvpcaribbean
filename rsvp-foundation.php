                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>RSVP Foundation</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                    <p>RSVP Caribbean has a registered non-profit charity that manages a Community Development
                    Fund which is 5% of each volunteer's programme fee. The Community Development Fund provides
                    support to community development projects and partners. The Board of Directors will select
                    projects through a call for proposals, initial review, site visit and then final review and
                    decision. The foundation will focus on the following themes: education, sanitation,
                    medicine and health care, sports, youth entrepreneurship, sustainable livelihoods and 
                    addressing issues related to children, the homeless, the elderly and persons living with disabilities.</p>
                </div>
            </section>
        </main><!-- Page Footer-->
        <!-- Default footer-->
