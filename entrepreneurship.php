                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Entrepreneurship Programme</h1>
                    ...
                    <div class="section-18">
                            <ul class="custom-item-list">
                                ...
                                <li><b>Types of Partners:</b> Government agencies, community groups</li>
                                <li><b>Population Served:</b> Youth and Adults</li>
                                <li><b>Age Group Served:</b> 15+</li>
                                <li><b>Number of People Cared For:</b> Varies for each partner</li>
                                <li><b>Minimum Stay:</b> From 4 weeks</li>
                                <li><b>Sustainable Development Goal:</b> Decent Work and Economic Growth</li>
                                <li><b>Programme Requirements:</b> Volunteers with studies or experience in business
                                development, entrepreneurship, accounting, finance, marketing, sales, human resource
                                management, information technology or any related area are suitable.</li>
                                ...
                                <li>
                                    <b>Price:</b> From $2,800USD per person, <a href="prices-jamaica.php">convert to your currency</a>.
                        ...
                        <div class="section-18">
                            <p>There are many creative business ideas that individuals need assistance with developing. The
                            environment is one that can enable creative thinking and innovation so entrepreneurship should
                            be encouraged and nurtured especially among our youth. The Entrepreneurship Programme supports
                            originality and will give individuals the opportunity to work on their dreams. Ideas will be
                            the foundation of this programme's business incubation whereby volunteers can help the youth to
                            develop their ideas in a practical way. Giving the youth opportunities to acquire a skill&nbsp;and
                            teaching them personal development skills is very important. Personal development workshops will also
                            be conducted.</p>
                            <p>As a volunteer, based on your skills and specific interests, you will work with individuals
                            to brainstorm their business ideas, conduct market research, develop business plans, develop marketing
                            and sales plans, test the market, create social media pages, create budgets, create cash flow
                            projections, create human resource components such as job advertisements, job descriptions,
                            performance appraisals and develop websites.</p>
                        </div>
                    </div>
                </div>
            </section>   
