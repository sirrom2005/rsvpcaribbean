                ...
                <div class="shell container">
                    ...
                    <div class="section-18">
                            <ul class="custom-item-list">
                                ...
                                <li><b>Types of Partners:</b> Hospitals and Homes for the elderly</li>
                                ...
                                <li><b>Programme Requirements:</b> Volunteers should have completed at least one year of
                                physiotherapy studies (observation only), or two years or more to access practical work
                                experience at the discretion of partners. Professionals will be asked to register to do
                                ...
                                <li>
                                    <b>What is Not Included :</b> Airfare, daily lunch, internet, laundry, travel and
                                    health insurance, please see <a href="what-not-included.php">What is Not Included</a> for a full list
                                </li>
                                <li><b>Start Dates:</b> Flexible</li>
                                <li><b>Age of Volunteer:</b> Must be 18+</li>
                            </ul>
                        <div class="section-18">
                            <p>Accessing physiotherapy care privately is very costly in the Caribbean. As such, many persons
                            depend on government agencies for this type of care. This results in the government system being
                            overburdened, under staffed and lacking sufficient resources. There is a long waiting period and
                            follow up is not continuous in some countries due to the volume of persons needing this specific type
                            of care. The contributing factors to the growing cases include birth defects, traffic accidents,
                            injuries on the job and lifestyle illnesses which result in physical damages. As a physiotherapy
                            volunteer you will assist with patient care for persons who have orthopedic cases, suffering from
                            stroke, experiencing muscle problems, chest conditions, developmental problems, back pains,
                            post-surgery care and brain disorders. As a volunteer you will assist with preparing and
                            completing treatment plans for patients. Practicing physiotherapists and physiotherapy students are
                            able to provide support in a hospital or infirmary where their skills are particularly needed.</p>
                        </div>
                    </div>
                </div>
            </section>   
