            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Programme Structure and Orientation</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Programme Structure and Orientation</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                    <div class="section-18">
                        <p>Once you have selected and paid for your preferred volunteer experience, you will receive full support to
                        help you prepare for your Caribbean experience. We will do everything possible to ensure that you understand
                        different aspects of the volunteering process and make the necessary preparations.</p>
                        
                        <p>Volunteers receive a full orientation the day after arrival. This includes a tour of the town, tips
                        on adapting to the culture, safety measures, customs, language, important landmarks, transportation system,
                        communication process and expectations for the duration of the RSVP volunteer experience. As a volunteer you
                        will work for a minimum of five (5) hours each day at  your assigned programme or project. You will be given a
                        timetable with the specific tasks you will perform while at the partner agency.</p>
                        
                        <p>There will be weekly site visits, follow-ups, workshops and cultural events and a monthly community
                        outreach dependent on the selected programme and its duration. There will be a community impact day once per
                        month. On the weekend if you are on any regular volunteer programme you will plan your own weekend
                        activities. You can always ask a staff member for suggestions. For special projects and groups, weekend
                        activities are organized by RSVP Caribbean.</p>
                        
                        <p>If you are in-country during times for any <a href="rsvp-special-projects.php">RSVP Special Projects</a> you can 
                        participate in those as well.</p>
                    </div>
                </div>
            </section>   
        </main><!-- Page Footer-->
