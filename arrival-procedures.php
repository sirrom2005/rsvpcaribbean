                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-5 text-lg-left">
                            <h1>Arrival Procedures</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12">
                        <div class="section-18">
                            <p>A month before arrival you will be given the
                            name and a picture of the RSVP Caribbean driver
                            that will pick you up at the airport. The driver
                            will have a sign, the details of which will be sent
                            to you by email, RSVP identification and will know
                            your name. The local customs and immigration
                            procedures will be explained and also what is
                            expected at the airport when you arrive. Upon
                            arrival a staff member will call the driver and
                            speak with you and explain the procedures for the
                            next 24 hours. Your host family will be expecting
                            you and the driver will take you directly to your
                            host family where you will meet your new family and
                            settle in. The following day a RSVP Caribbean staff
                            will pick you up at your host family and take you
                            for an orientation.</p>
                        </div>
                    </div>   
                </div>  
			</section>		
