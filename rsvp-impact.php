...
<body>
    ...
    <div class="page about-t">
        ...
        <section class="breadcrumb-classic section-pattern2 first-bc-margin text-center">
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <h2><span class="big">Programme and Project</span></h2>
                    </div>
                    <div class=
                    "offset-top-0 offset-sm-top-10 cell-lg-5 offset-lg-top-0 small cell-lg-push-3 text-lg-right">
                    <ul class="list-inline list-inline-dashed p">
                            <li><a href="index.php">Home</a></li>
                            <li><a href="programmeandproject.php">Programme &amp; Project</a></li>
                            <li>RSVP impact</li>
                        </ul>
                    </div>
                </div>
        ...
        <main class="page-content">
			<!-- RSVP IMPACT -->
            <section class="section-98 section-sm-40 progrrame-impact">
                <div class="shell container">
                    ...
                    <div class="section-sm-top-50">
                        <div class="row">
                            <div class="col-md-12">
                                <h2>Goals for the next 5 years (2016 – 2020)
                                </h2>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <ul class="impact-li">
                                    <li>Number of destinations - 3</li>
                                    <li>Number of programmes - 22</li>
                                    <li>Number of projects – 8</li>
                                    <li>Special projects – 5</li>
                                </ul>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <ul class="impact-li">
