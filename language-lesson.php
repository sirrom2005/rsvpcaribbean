            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Language Lessons Project</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Language Lessons Project</h1>
                    ...
                    <div class="section-18">
                      <ul class="custom-item-list">
                          ...
                          <li><b>Languages:</b> English and Patois</li>
                          <li>
                              <b>Project Requirements:</b> No requirements for English, a basic command
                              of the English Language for patois, see <a href="rsvp-services.php">Language Lesson Service</a>
                          </li>
                          <li><b>Work Schedule:</b> 5 hours per day, Monday – Friday</li>
                          <li><b>Accommodation Type:</b> Host Family</li>
                          <li>
                              <b>Price:</b> From $1,800USD per person, <a href="prices-jamaica.php">convert to your currency</a>.
