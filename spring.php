                ...
                <div class="shell container">
                    ...
                    <div class="section-18">
                      <ul class="custom-item-list">
                          ...
                          <li><b>Available Projects:</b> <a href="care-protection.php">Child Care and Protection</a>, <a href="medicine-care.php">Medicine and Health Care</a> and 
                          <a href="humanitarian.php">Humanitarian</a></li>
                          
                          <li><b>Minimum Stay:</b> 1 week</li>
                          <li><b>Sustainable Development Goal:</b> Good Health and Well-Being and No Poverty</li>
                          <li><b>Project Requirements:</b> No specific requirement from some partners so anyone with a love for children and
                          the passion to serve can join the programme.<br><br>
                          Volunteers with an interest in, or studying, social work, psychology, sociology or any
                          related area are suitable for the child care and protection.<br><br>
                          Volunteers with an interest in, or studying, building, construction,
                          architecture, renovations, painting, carpentry, plumbing or any related area are suitable for
                          the humanitarian programme.</li>
                          ...
                          <li>
                              <b>Price:</b> From $1,000USD per person <a href="prices-jamaica.php">convert to your currency</a>.
    ...
    $document.ready(function(){
      $('.popup').each(function() {
        $(this).on('click', function() {
          ...
          $.get('layout/project_content.php?project=spring_break&section=' + getSection, function( data ) {
