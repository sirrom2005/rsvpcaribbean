            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Become a RSVP Representative</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Become a RSVP Representative</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                    <p>Are you passionate about promoting a culture of
                    volunteerism and want to assist Team RSVP in
                    marketing our programmes at your school,
                    organization, community or company overseas? If you
                    are excited about this then contact us and we will
                    tell you how you can become a RSVP Representative.
                    Your role is to promote RSVP Caribbean volunteering
                    services at your school, college, university,
                    company, organization, community and network. We
                    provide an attractive incentive package (free trip,
                    commission and other incentives). Please send your
                    cover letter and CV in one Microsoft Word or PDF
                    document to <a href=
                    "mailto:rsvprep@rsvpcaribbean.com">rsvprep@rsvpcaribbean.com</a> with subject line
                    RSVP Representative.</p>
                    <p><b>No telephone calls, please.</b></p>
                </div>
            </section>
