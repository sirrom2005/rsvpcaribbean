            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Summer Project Timetable - Sports</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Summer Project Timetable - Sports</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                                       
                    <p>This is an example of the schedule for the Sports Summer Project. This is subject to change and volunteers are provided with updates as necessary. 
                    If you have any questions send an email to <a href="mailto:info@rsvpcaribbean.com">info@rsvpcaribbean.com</a>.</p>
                    ...
                    <table class="table rsvp">
                     ...
                     <tr>
                      ...
                      <td>Arrival</td>
                      <td>Tour</td>
                      <td>Warm Up and Team Building</td>
                      <td>Warm Up, Football and Netball</td>
                      <td>Warm Up, Track and Field</td>
                      <td>Warm Up, Track and Field</td>
                     ...
                     <tr>
                      ...
                      <td>Volleyball</td>
                      <td>Volleyball</td>
                      <td>Personal Development Workshop</td>
                      <td>Introduction of new sport by volunteers</td>
                      <td>Craft market</td>
                     </tr>
                     <tr>
                      <th>2:00pm - 4:00pm</th>
                    ...
                    <table class="table rsvp">
                     ...
                     <tr>
                      <th>10:00am - 11:00am</th>
                      <td>YS Falls</td>
                      <td>Cricket and Netball</td>
                      <td>Football and Netball</td>
                      <td>Track and Field</td>
                      <td>Team Preparation: Sports Day</td>
                      <td>Sports Day</td>
                      <td>Departure</td>
                     </tr>
                     <tr>
                     ...
                     <tr>
                      <th>1:00pm - 2:00pm</th>
                      <td>Travel</td>
                      <td>Cheerleading and Volleyball</td>
                      <td>Planning for Sports Day</td>
                      <td>Planning for Sports Day</td>
                      <td>Games</td>
                      <td>Sports Day</td>
                      <td>Departure</td>
