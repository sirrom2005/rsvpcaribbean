                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-5 text-lg-left">
                            <h1>RSVP Guarantees</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                    <div class="section-18">
                        <ul class="custom-item-list">
                            <li><b>Resource Allocation -</b> we guarantee that resources will be provided to programmes and projects.</li>
                            <li><b>Donation -</b> we guarantee that once per quarter a tangible donation will be made to an
                            institution or individual in need; from one of the RSVP Caribbean destinations.</li>
                            <li><b>Community Impact -</b> we guarantee that 5% of your programme fee will go towards a Community
                            Development Fund to support community projects and partner needs through the RSVP Foundation.</li>
                            <li><b>Needs-Based Programmes and Projects -</b> we guarantee that you will have a meaningful programme
                            or project that allows you to make a difference.</li>
                            <li><b>Exceptional Service -</b> we guarantee to deliver excellent service that exceeds your expectations.</li>
                            <li><b>Efficient Service -</b> we guarantee to always respond on time (within 48 hours for weekday
                            queries and within 72 hours for weekend queries), for late replies you will receive 2% discount; if we are not on time you pay 
                            less.</li>
                            <li><b>Confidentiality -</b> We guarantee complete privacy of information collected from you and on your behalf.</li>
                            <li><b>Uniqueness -</b> we guarantee a customized approach to each volunteer and will take your
                            particular situation, expectations and needs into consideration at all times.</li>
                        </ul>
                    </div>
                </div>
            </section>
