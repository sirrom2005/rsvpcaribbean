...
<body>
    ...
    <div class="page">
        ...
        <section class="breadcrumb-classic first-bc-margin">
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <h2><span class="big">Press Releases</span></h2>
                    </div>
                    <div class=
        ...
        <?php 
        include('layout/press_content.php'); 
            ...
            <div class="section-18">
              <article class="post post-default text-left">
                <div class="header post-header">
                  <h3 class="post-title">
                    <a href="'. $_SERVER['SCRIPT_NAME'] .'?id='. $key .'">'. $item['title'] .'</a> 
                ...
                <section class="post-content offset-top-41">
                  ...
                  <a href="'. $_SERVER['SCRIPT_NAME'] .'?id='. $key .'" class="offset-top-24 btn btn-default btn-primary" style="color: #fff">Read More</a>
                </section>
              </article>
            </div>
