            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Summer Project Timetable - Humanitarian</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Summer Project Timetable - Humanitarian</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                                       
                    <p>This is an example of the schedule for the Humanitarian Summer Project. This is subject to change and volunteers are provided with updates as necessary. 
                    ...
                    <table class="table rsvp">
                     ...
                     <tr>
                      ...
                      <td>Arrival</td>
                      <td>Tour</td>
                      <td>Fixing/Erecting Walls</td>
                      <td>Fixing/Erecting Walls</td>
                      <td>Fixing/Erecting Walls</td>
                      <td>Installing Window and Doors</td>
                     ...
                     <tr>
                      ...
                      <td>Fixing/Erecting Walls</td>
                      <td>Fixing/Erecting Walls</td>
                      <td>Installing Windows and Doors</td>
                      <td>Beach</td>
                     </tr>
                     <tr>
