  ...
  <body>
    ...
    <div class="page">
      ...
      <main class="page-content">
        ...
        <!-- PROGRAMME AND PROJECT PRICES - GRENADA -->
        <section class="section-41">
          ...
          <div class="shell container">
                ...
                <div class="text-lg-left">
                    <h1>Price List - Programmes and Projects - Grenada</h1>
			...
			<p></p>
				<div id="pricing-grenada" class="info-table "> 
                  ...
                  <a class="update-price-btn" data-element="pricing-grenada" data-mode="plus" href="javascript:void(null);"><i class="fa fa-plus"></i></a> 
                  <a class="update-price-btn" data-element="pricing-grenada" data-mode="minus" href="javascript:void(null);"><i class="fa fa-minus"></i></a>
                </th>
							</tr>
						</thead>
						<tbody> 
							<tr> 
								...
								<td>$3,800USD</td>
								<td>$4,200USD</td>
								<td class="extra-week-price" data-price-base="4200" data-price="200">$4,400USD</td>
							</tr>
							<tr> 
								<td>Teaching</td>
								<td>N/A</td>
      ...
      <div class="section-18">
          ...
          <li>The length of your programme is calculated from your arrival date to your departure date; if you will spend all your 
          time on the programme. If you are doing independent travel after your programme then your programme date is your arrival 
          date until your last date on the programme. Please ensure that your insurance covers your entire trip. </li>
          <li>If you stay on your programme over the agreed length of time reflected on your invoice you will be charged $90USD per 
          day to cover your food, accommodation and support.</li>
				</ul>
			</div>	
		</div>
	</div>
