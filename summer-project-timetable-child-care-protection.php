            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Summer Project Timetable - Child Care and Protection</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-12 text-lg-left">
                            <h1>Summer Project Timetable - Child Care and Protection</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                                       
                    <p>This is an example of the schedule for the Child Care and Protection Summer Project. This is subject to change and volunteers are provided with 
                    updates as necessary. If you have any questions send an email to <a href="mailto:info@rsvpcaribbean.com">info@rsvpcaribbean.com</a>.</p>
                    ...
                    <table class="table rsvp">
                     ...
                     <tr>
                      ...
                      <td>Tour</td>
                      <td>Vision Board</td>
                      <td>Hygiene Workshop</td>
                      <td>Etiquette Workshop</td>
                      <td>Story Telling</td>
                    ...
                    <table class="table rsvp">
                     ...
                     <tr>
                      ...
                      <td>Child Rights Workshop</td>
                      <td>Creativity Workshop</td>
                      <td>Oral and Dental Health Workshop</td>
                      <td>Concert and Fun Day</td>   
                      <td>Departure</td>
                     </tr>
                     <tr>
                      <th>10:00am - 11:00am</th>
