  ...
  <body>
    ...
    <div class="page">
      ...
      <main class="page-content">
        ...
        <!-- PROGRAMME AND PROJECT PRICES – ST. LUCIA -->
		<section class="section-41">
            <div class="shell container">
            <div class="range">
                <div class="text-lg-left">
                    <h1>Price List - Programme and Project Prices - St. Lucia</h1>
      ...
      <!-- Currency Converter Script - EXCHANGERATEWIDGET.COM -->
			...
			<div class="for-pricing-table"> 
			   <p></p>
				<div id="pricing-lucia" class="info-table">
          ...
          <table class="table table-first"> 
                  ...
                  <a class="update-price-btn" data-element="pricing-lucia" data-mode="plus" href="javascript:void(null);"><i class="fa fa-plus"></i></a> 
                  <a class="update-price-btn" data-element="pricing-lucia" data-mode="minus" href="javascript:void(null);"><i class="fa fa-minus"></i></a>
                </th>
							</tr>
						</thead>
						<tbody> 
            ...
            all your time on the programme. If you are doing independent travel after your programme then your programme date 
            is your arrival date until your last date on the programme. Please ensure that your insurance covers your entire trip.</li>
