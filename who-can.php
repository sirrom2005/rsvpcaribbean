...
<body>
    ...
    <div class="page about-t">
            ...
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <ul class="list-inline list-inline-dashed p">
                            ...
                            <li>Who Can Volunteer with RSVP?</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <main class="page-content">
            ...
            <!-- WHO CAN VOLUNTEER WITH RSVP? -->
            <section class="section-41">
                <div class="shell container">
                    <div class="range">
                        <div class="cell-lg-5 text-lg-left">
                            <h1>Who Can Volunteer with RSVP?</h1>
                            <hr class="divider bg-mantis hr-lg-left-0">
                        </div>
                    </div>
                        <p>RSVP Caribbean accepts volunteers who are as young as 16 years old upon arrival in-country. There is no upper age limit, once volunteers are healthy,
                        enthusiastic and dedicated they can volunteer on our programmes and projects. So if you are in high school, taking a gap year, a recent graduate, a college or
                        university student, retired, a career breaker, employee, professional or in any other category in any field, then RSVP Caribbean has a programme or project
                        for you; once you meet the requirements. Interested persons of all backgrounds, experience and nationalities can apply – we welcome diversity. Why not
                        Respond…so you can Discover and Change Lives.</p>
                </div>
            </section>
