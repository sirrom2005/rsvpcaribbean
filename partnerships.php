        ...
        <section class="breadcrumb-classic section-pattern2 first-bc-margin text-center">
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <h2><span class="big">Partnerships</span></h2>
                    </div>
                    <div class=
                ...
                <div class="shell container">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="section-18">
                            <p>Our partners play an important role in the work that we do. Without them we would not have suitable programmes and projects for our volunteers. 
                            We value their role and their contribution in working with us to focus on key issues in the Caribbean. Their knowledge, expertise, dedication and passion
                            to see change supports the vision of RSVP Caribbean and we are happy to have them on board.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <div class="single-partner">
                                <h4>Partners – Grenada</h4>
                                <ul class="custom-item-list">
                                    <li>Orphanages</li>
                                    <li>Child care facilities</li>
                                    <li>Children’s Home</li>
                                    <li>Government agencies and
                                    departments</li>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="single-partner">
                                <h4>Partners - Jamaica</h4>
                                <ul class="custom-item-list">
                                    <li>Orphanages</li>
                                    <li>Child Care Facilities</li>
                                    <li>Children's Home</li>
                                    <li>Homes for the elderly</li>
                                    <li>Government agencies and
                                    departments</li>
                                    <li>Non-government organizations</li>
                                    <li>Hospitals</li>
