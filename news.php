...
<body>
    ...
    <div class="page">
        ...
        <section class="breadcrumb-classic first-bc-margin">
            <div class="shell section-34 section-sm-50">
                <div class="range range-lg-middle">
                    ...
                    <h2><span class="big">News and Updates</span></h2>
                    </div>
                    <div class=
        ...
        <?php 
        include('layout/news_content.php'); 
          ...
          if(empty($id)):
            ...
            <div class="section-18">
              <article class="post post-default text-left">
                <div class="header post-header">
                  <h3 class="post-title">
                    <a href="news.php?id='. $key .'">'. $news['title'] .'</a> 
                    <span class="text-middle icon-xxs text-picton-blue mdi mdi-clock"></span> 
                    <time datetime="2016-01-01" class="text-middle small">'. $news['date'] .'</time>
                  </h3>
                </div>
                <section class="post-content offset-top-41">
                  <p>'. substr(strip_tags($news['content']), 0, strrpos(substr(strip_tags($news['content']), 0, 400), ' ')) .'...</p>
                  <a href="news.php?id='. $key .'" class="offset-top-24 btn btn-default btn-primary" style="color: #fff">Read More</a>
                </section>
              </article>
            </div>
            ...
            <div class="section-18">
              <article class="post post-default text-left">
                ...
                <section class="post-content section-18"><img class="img-responsive img-thumbnail" src="'. $news['image'] .'" alt="'. $news['title'] .'"></section>
                <section class="post-content section-18">'. $news['content'] .'</section>
              </article>
            </div>
            <hr class="hr offset-top-66">
            ';
