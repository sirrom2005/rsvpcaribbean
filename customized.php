        ...
        <main class="page-content">
           <section class="section-41">
                <div class="shell container">
                    ...
                    <p>If you have checked out the programmes and projects but you are not seeing anything of interest to you please 
                    <a href="contact-us.php">Contact Us</a> and let us know. If you have a particular interest then complete the 
                    <a href="contact-us.php">Enquiry Form</a> and our team at RSVP Caribbean will research your interest and let 
                    you know if it is possible. If it's possible we will do everything to make it happen.</p>
                    ...
                    <div class="section-18">
                      <ul class="custom-item-list">
                          ...
                          <li><strong>Project Requirements:</strong> Be qualified and knowledgeable in area of interest</li>
                          <li><strong>Work Schedule:</strong> 5 hours per day, Monday – Friday</li>
                          <li><strong>Accommodation Type:</strong> Host Family</li>
                          <li><strong>Price:</strong> From $1,900USD per person, <a href="prices-jamaica.php">convert to your currency</a>. Please see 
                          <a href="prices-jamaica.php">Programme and Project Price</a> for Jamaica</li>
                          <li><strong>Meals Included:</strong> Breakfast and dinner (adapted to dietary requirements as necessary)</li>
                          <li><strong>What is Included:</strong> 24-hour support, accommodation, programme, two meals, transportation to and from the 
                          airport, taxi cost from host family to partner agency, please see <a href="what-included.php">What is Included</a> for a full list</li>
                          ...
                          <li><strong>Age of Volunteer:</strong> Must be 21+</li>
                      </ul>
                      <p><b>Let us customize your project - <a href="contact-us.php">Request a Quote and Timetable</a></b></p>
                    </div>
                </div>
            </section> 
        </main><!-- Page Footer-->
